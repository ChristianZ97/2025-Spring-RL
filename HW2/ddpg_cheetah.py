...
class Actor(nn.Module):
    def __init__(self, hidden_size, num_inputs, action_space):
        ...
        for layer in [self.fc1, self.fc2, self.fc3]:
            nn.init.orthogonal_(layer.weight, gain=np.sqrt(0.5))
...
class DDPG(object):
    def __init__(self, num_inputs, action_space, gamma=0.995, tau=0.0005, hidden_size=128, lr_a=3e-4, lr_c=1e-3):
        ...
        self.critic_scheduler = StepLR(self.critic_optim, step_size=1000, gamma=0.99)
    ...
    def update_parameters(self, batch):
        ...
        with torch.no_grad():
            ...
            target_q = torch.clamp(target_q, min=-1000.0, max=1000.0)
