...
class Actor(nn.Module):
    def __init__(
        ...
        self.hidden1 = nn.Linear(in_dim, 512) # 128 -> 512
        self.hidden2 = nn.Linear(512, 512) # 128 -> 512

        # set log_std layer
        self.log_std_layer = nn.Linear(512, out_dim) # 128 -> 512
        self.log_std_layer = init_layer_uniform(self.log_std_layer)

        # set mean layer
        self.mu_layer = nn.Linear(512, out_dim) # 128 -> 512
...
class CriticQ(nn.Module):
    def __init__(self, in_dim: int):
        ...
        self.hidden1 = nn.Linear(in_dim, 512) # 128 -> 512
        self.hidden2 = nn.Linear(512, 512) # 128 -> 512
        self.out = nn.Linear(512, 1) # 128 -> 512
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb-run-name", type=str, default="halfcheetah-sac") # "pendulum-sac" -> "halfcheetah-sac"
    ...
    parser.add_argument("--num-steps", type=float, default=300000) # 100000 -> 300000
    ...
    # W&B init
    wandb.init(project="RL-HW3-SAC-HalfCheetah-final", name=args.wandb_run_name, save_code=True)
